...
class HistoryNode extends StatelessWidget {
  ...
  const HistoryNode({super.key, required this.position, this.icon});

  @override
  Widget build(BuildContext context) {
    return TimelineNode(
      startConnector: position != PlacementType.start
          ? const SolidLineConnector(color: Colours.chineseWhite)
          : null,
      endConnector: position != PlacementType.end
          ? const SolidLineConnector(color: Colours.chineseWhite)
          : null,
